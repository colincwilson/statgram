...
gen_rules += [x +' -> '+ y +' '+z for x in non_terminals
                for y in non_terminals for z in non_terminals]
...
# # # # # # # # # #
# Grammar
rules = ['S -> A0', 'S -> A1', 'S -> F0',
         'A0 -> B C', 'A1 -> D E', 'F0 -> B E',
         'B -> b', 'C -> c', 'D -> d', 'E -> e']
...
# # # # # # # # # #
# Eval
Con = [need_parent, need_daught0, need_daught1,
       good_parent, good_daught0, good_daught1]
